...
<Meta title="React/Developing/Getting Started" />
...
1. [Environment Setup](#id=react-developing-getting-started--page&viewMode=docs#environment-setup)
1. [Editor Config](./?path=/docs/react-developing-configuring-your-editor--page)
1. [Learn about some design choices that have been made](./?path=/docs/react-developing-conventions--page)
1. [Build all the things!](./?path=/docs/react-developing-building-a-component--page)
...
├─ components
├─ stories (for documentation only)
...
See [Configuring Your Editor](./?path=/docs/react-developing-configuring-your-editor--page)
...
It is recommended to read over some conventions chosen for the Mainsail-UI library before diving in.

See [Conventions](./?path=/docs/react-developing-conventions--page)
