...
<Meta title="React/Developing/Configuring Your Editor" />
...
Once you run `yarn install` on the project, you should have the necessary linters and plugins for the project **but** you will still need to install the editor plugin to enable operation during editing.
...
### I got nothing going on (ESLINT / PRETTIER)
